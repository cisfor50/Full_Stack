...
//funcion definida para crear el menu de los estados
...
function createHouseTable(){
	...
	var elSenateTable = document.getElementById('house-data');
 
	tableEl = addTableToHTML(dataHouse.results[0].members);
...
//la funcion filtrarMiembros se posiciona en la linea 4865
